...
Výukové materiály pro PyLadies Praha (podzim 2026).
...
```
01_print/       výpisy na obrazovku (print)
02_aritmetika/  počítání s čísly
03_promenne/    proměnné
04_input/       vstup od uživatele
```
...
reseni/cviceni_bonus.py    řešení bonusů
```

## Tahák

Rychlý přehled celé lekce na jednu stránku najdeš v [TAHAK.md](TAHAK.md) (klidně si ho vytiskni na A4).
